// @ts-check
//  ケース内容定型文章マスタの検索
const Service = require('../../SIENC/MstCaseTeikei/Service')
const service = new Service();
const ApiRun = require('../ApiRun');
const apiRun = new ApiRun();
exports.connected = async function (param) {
  apiRun.setQuery(param);
  let url = apiRun.getDomain() + '/sodan/v1/mst/case-teikei/?' + apiRun.getQuery();
  apiRun.setURL(url);
...
exports.registed = async function (query, data) {
  let url = apiRun.getDomain() + '/sodan/v1/mst/case-teikei/';
  apiRun.setURL(url);
