// @ts-check
//   地域相談支援-アセスメント履歴を取得
const Service = require('../../SIENC/MstChikiAsesReki/Service')
const service = new Service();
const ApiRun = require('../ApiRun');
const apiRun = new ApiRun();
exports.connected = async function (param) {
  apiRun.setQuery(param);
  let url = apiRun.getDomain() + '/sodan/v1/mst/chiki-ases-reki/?' + apiRun.getQuery();
  apiRun.setURL(url);
...
exports.deleted = async function (query, data) {
  ...
  let url = apiRun.getDomain() + '/sodan/v1/mst/chiki-ases-reki/';
