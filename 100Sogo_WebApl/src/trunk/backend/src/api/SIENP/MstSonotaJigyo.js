// @ts-check
//  その他事業所マスタ
const Service = require('../../SIENP/MstSonotaJigyo/Service')
...
exports.connected = async function (param) {
  ...
  let url = apiRun.getDomain() + '/sodan/v1/mst/sonota-jigyo/?' + apiRun.getQuery();
  apiRun.setURL(url);
...
exports.registed = async function (query, data) {
  ...
  let url = apiRun.getDomain() + '/sodan/v1/mst/sonota-jigyo';
  apiRun.setURL(url);
