// @ts-check
// アセスメント履歴
const Service = require('../../SIENP/MstAsesReki/Service')
...
exports.connected = async function (param) {
  ...
  let url = apiRun.getDomain() + '/sodan/v1/mst/ases-reki/?' + apiRun.getQuery();
  apiRun.setURL(url);
...
exports.registed = async function (query, data) {
  let url = apiRun.getDomain() + '/sodan/v1/mst/ases-reki/';
  apiRun.setURL(url);
