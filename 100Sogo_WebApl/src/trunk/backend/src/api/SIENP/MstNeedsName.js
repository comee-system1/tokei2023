// @ts-check
// ニーズ整理項目名
const Service = require('../../SIENP/MstNeedsName/Service')
...
exports.connected = async function (param) {
  ...
  let url = apiRun.getDomain() + '/sodan/v1/mst/needs-name/?' + apiRun.getQuery();
  apiRun.setURL(url);
...
exports.registed = async function (query, data) {
  let url = apiRun.getDomain() + '/sodan/v1/mst/needs-name';
  apiRun.setURL(url);
