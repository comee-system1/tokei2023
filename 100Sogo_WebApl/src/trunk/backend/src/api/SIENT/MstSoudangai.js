// @ts-check
// 相談外業務マスタ
const Service = require('../../SIENT/MstSoudangai/Service')
const service = new Service();
const ApiRun = require('../ApiRun');
const apiRun = new ApiRun();
exports.connected = async function (param) {
  apiRun.setQuery(param);
  let url = apiRun.getDomain() + '/sodan/v1/mst/soudangai/?' + apiRun.getQuery();
  apiRun.setURL(url);
...
exports.registed = async function (query, data) {
  let url = apiRun.getDomain() + '/sodan/v1/mst/soudangai/';
  apiRun.setURL(url);
