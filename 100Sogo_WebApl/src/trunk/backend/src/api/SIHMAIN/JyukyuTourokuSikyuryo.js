const Service = require('../../SIHMAIN/JyukyuTourokuSikyuryo/Service')
...
exports.connected = async function (param) {
  ...
  var url = apiRun.getDomain() + '/syogai/daityo/v1/jyukyu/sikyuketei?' + apiRun.getQuery();
  apiRun.setURL(url);
...
exports.registed = async function (param, data) {
  ...
  let url = apiRun.getDomain() + '/syogai/daityo/v1/jyukyu/sikyuketei?' + apiRun.getQuery();
  apiRun.setURL(url);
  apiRun.setUniqID(param.uniqid);
  apiRun.setTraceID(param.traceid);
